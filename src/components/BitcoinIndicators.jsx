...
const BitcoinIndicators = () => {
  ...
  const fetchIndicatorsData = async () => {
    const options = {
      method: "GET",
      url: "https://api.coingecko.com/api/v3/coins/bitcoin", // Correct endpoint for Bitcoin data
    };
    ...
    try {
      ...
      console.error(err);
      setError("Failed to fetch Bitcoin indicators. Please try again.");
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="container mt-5">
      ...
      <div className="mt-4">
        {data ? (
          <div className="card shadow-lg" style={{ backgroundColor: "#F9F9F9" }}>
            ...
            <div className="card-body">
              <p>
                ...
                <strong>Circulating Supply:</strong> {data.market_data?.circulating_supply || "N/A"} BTC <br />
          ...
          >
            Click "Fetch Indicators" to view Bitcoin data.
          </div>
        )}
